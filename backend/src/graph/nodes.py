...
def audit_content_node(state: VideoAuditState) -> Dict[str, Any]:
    ...
    logger.info("--- [Node: Auditor] LLM Connection established 2---")
...
#     endpoint = "https://brand-guardian-bits.cognitiveservices.azure.com/"
...
#         endpoint=endpoint,
#         credential="GC6YdyZuHBDu8g5gU323Bvp3k2lHBwmQtIWjzVYBOMtxGWROJQD9JQQJ99CGACYeBjFXJ3w3AAAAACOGaCHg"
#    )
